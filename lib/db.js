...
// Support both DATABASE_PATH (as documented in deployment guide) and DB_PATH
const dbPath = process.env.DATABASE_PATH || process.env.DB_PATH || path.join(process.cwd(), 'data', 'database.db');
